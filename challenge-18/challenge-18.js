(function() {
  ...
  */
  ...
  console.log(
    cleanCPF("049-214 3421-1").slice(0, 3) +
      "." +
      cleanCPF("049-214 3421-1").slice(3, 6) +
      "." +
      cleanCPF("049-214 3421-1").slice(6, 9) +
      "-" +
      cleanCPF("049-214 3421-1").slice(9)
  );
  console.log(
    cleanCPF("210.458.522-05").slice(0, 3) +
      "." +
      cleanCPF("210.458.522-05").slice(3, 6) +
      "." +
      cleanCPF("210.458.522-05").slice(6, 9) +
      "-" +
      cleanCPF("210.458.522-05").slice(9)
  );
  console.log(
    cleanCPF("735 500 794 - 22").slice(0, 3) +
      "." +
      cleanCPF("735 500 794 - 22").slice(3, 6) +
      "." +
      cleanCPF("735 500 794 - 22").slice(6, 9) +
      "-" +
      cleanCPF("735 500 794 - 22").slice(9)
  );
  console.log(
    cleanCPF("101.123-131x32").slice(0, 3) +
      "." +
      cleanCPF("101.123-131x32").slice(3, 6) +
      "." +
      cleanCPF("101.123-131x32").slice(6, 9) +
      "-" +
      cleanCPF("101.123-131x32").slice(9)
  );
  ...
  */
  ...
  console.log(
    "Os meses de janeiro, junho e julho começam com a letra j.".match(/ju\who/g)
  );
